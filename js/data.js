...
// Toutes les données : vocabulaire, phrases, grammaire, lieux, constantes
// NE PAS MODIFIER la structure — ajouter du contenu à l'intérieur des objets existants
...
const LOCATIONS = [
  {id:'church',emoji:'⛪',color:'#6a50a8',x:0.42,y:0.28,w:0.10,h:0.12,npcs:[
...
// ÉTAT GLOBAL (utilise window.S déjà créé par state.js qui est chargé AVANT)
